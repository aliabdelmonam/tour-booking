...
reviewRouter.route("/get_Reviews_ByTourId/:tour_id").get(reviewController.getReviewsByTourId);
reviewRouter.route("/get_Avg_Rating_Review_ByTourId/:tour_id").get(reviewController.getAvgRatingReviewByTourId);
